...
RUN wget https://github.com/daid/EmptyEpsilon/releases/download/EE-2020.03.22/Linux_EmptyEpsilon_EE-2020.03.22.deb
RUN apt install -y libglu1-mesa novnc xserver-xorg net-tools
RUN apt install -y ./Linux_EmptyEpsilon_EE-2020.03.22.deb
